...
const autenticar = async (req, res) => {
    ...
    //Comprobar si el Usuarop está confirmado 
...
const comprobarToken = async (req, res) => {
    ...
    if(!usuario) {
        return res.render('auth/confirmar-cuenta', {
            pagina: 'Reestablece tu Password',
            mensaje: 'Hubo un error al validar tu infomación, intenta de nuevo',
            error: true
    ...
    // mostrar formuario para modificar el password
